...
class Main {
    ...
    public function deleteMenu() {
        ...
        if ($this->roster->getCount() === 0) { 
            echo "\nNo employees in the roster.\n";
        ...
        echo "*** Employee List\n";
        $this->roster->displayForDelete();  
        $slot = readline("Enter the Employee number to be deleted: ");
        ...
        if (!is_numeric($slot)) {
            echo "Invalid input. Please enter a valid slot number.\n";
            readline("Press \"Enter\" key to continue...");
            $this->deleteMenu(); 
            return;
        }
